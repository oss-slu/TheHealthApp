  ...
  resources: {
    en: {
      ...
      modules: {
        ...
        tba: 'Health Support',
        cardioRiskAssessment: 'Cardiovascular Risk Assessment',
        cardioRiskAssessmentDescription: 'Evaluate your cardiovascular health risk',
        ...
        heartRiskMlEmpty: 'The screening service returned no usable result. Please try again.',
        heartRiskMlInvalid: 'We could not read the screening result. Please try again.',
        heartRiskNetworkError: 'Could not reach the screening service. Check your connection and try again.',
      },
      errors: {
